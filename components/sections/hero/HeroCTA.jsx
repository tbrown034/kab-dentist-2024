...
const HeroCTA = () => {
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      {/* Call Us - DisplayNumber handles the anchor tag */}
      <DisplayNumber
        className="group relative inline-flex items-center justify-center gap-3 sm:gap-2.5 rounded-2xl px-6 sm:px-7 py-4 text-base sm:text-lg font-semibold backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 border border-gray-200/50 dark:border-gray-700/50 text-gray-900 dark:text-gray-100 shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] hover:bg-white/90 dark:hover:bg-gray-800/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 tracking-wide"
        showIcon={true}
