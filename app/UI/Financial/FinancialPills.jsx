      ...
      <div className="flex flex-col justify-center gap-2 p-4 bg-white border-2 border-teal-800 shadow rounded-xl">
        ...
        <div>
          <a
            ...
            className="p-2 px-6 text-sm text-white bg-teal-500 rounded-lg shadow hover:bg-teal-600 focus:outline-none focus:ring-4 focus:ring-teal-500 focus:ring-offset-2 active:bg-teal-700"
          >
            Apply Now
          </a>
        </div>
