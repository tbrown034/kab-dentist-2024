...
const EmergencyBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-20 flex items-center w-full gap-4 px-6 py-3 text-xs sm:text-sm lg;text-lg bg-teal-800 border-t border-gray-200 sm:gap-2 dark:border-gray-700 ">
